...
<meta property="og:title" content="Politics" />
    <meta property="og:description" content="Que y como votan nuestros representantes" />
...
<link href="/apps/politic/css/wizard.css?version=6" rel="stylesheet" type="text/css" />
...
<body>
   ...
   <div id="content">
      <?php include("menu.php"); ?>
        ...
        <div id="contCentral" class="columna"  style="width: 70%; padding:5px;">
        <?php
        if(isset($_GET['id'])){
            $idnota = $_GET['id'];
            include("nota".$idnota.".php");
          }else{
            $idnota =1;
            include("nota".$idnota.".php");
          }
